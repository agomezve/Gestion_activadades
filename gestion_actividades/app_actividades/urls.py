...
urlpatterns = [
    ...
    # Inscripciones
    path('actividades/<int:id>/inscripciones/', views.listar_inscripciones_actividad, name='listar_inscripciones_actividad'),
    path('actividades/<int:id>/inscribir/', views.inscribir_usuario, name='inscribir_usuario'),
    path('actividades/<int:id>/inscripciones/<int:usuario_id>/eliminar/', views.cancelar_inscripcion, name='cancelar_inscripcion'),
]
